...
Route::middleware('admin')->group(function () {
    ...
    Route::post('/rooms/print', [RoomController::class, 'printLabel']);
    ...
    Route::put('/rooms/barang/{barang:id}', [RoomController::class, 'updateBarang']);
    Route::delete('/rooms/barang/{barang:id}', [RoomController::class, 'destroyBarang']);
});
